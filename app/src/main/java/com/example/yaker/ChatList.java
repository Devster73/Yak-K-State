...
public class ChatList extends AppCompatActivity {
    ...
    DatabaseReference heatmapDatabase;
    MyAdapter myAdapter;
    ArrayList<Chat> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currLocation = new Location("Test");
        ...
        heatmapDatabase = FirebaseDatabase.getInstance().getReference("Heatmap");
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                findLocation(currLocation);

                Chat chat = new Chat();
                chat.likes = 0;

                chat.chatMessage = chatMessage.getText().toString();
                chat.location = locationName;
                chatMessage.setText("");
                Log.d("TAGGY2","Test: "+locationName);


                heatmapDatabase.push().setValue(currLocation);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    if (!dataSnapshot.getKey().equals("Willie")){
                        ...
                        chat.location = dataSnapshot.child("location").getValue().toString();
    ...
    private void findLocation(Location location) {
        ...
        if (ContextCompat.checkSelfPermission(ChatList.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
            ...
            ActivityCompat.requestPermissions(ChatList.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION}, 1);
        }
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 10, 1, new LocationListener() {
            @Override
            public void onLocationChanged(@NonNull Location location) {
                currLocation = location;
               // Toast.makeText(ChatList.this, "Location: " + currLocation, Toast.LENGTH_SHORT).show();
            }
        });
        if (location != null) {
